...
db.vehicle_Availability = require('../models/vehicle_availability.js')(sequelize, Sequelize);
db.locations = require('../models/locations.js')(sequelize, Sequelize);
db.eco_friendly = require('../models/eco_friendly.js')(sequelize, Sequelize);
db.fuel_type = require('../models/fuel_type.js')(sequelize, Sequelize);
db.vehicle_mandatory_features = require('../models/vehicle_mandatory_features.js')(sequelize, Sequelize);
db.vehicle_images = require('../models/vehicle_images.js')(sequelize, Sequelize);
module.exports = db;